...
public class RenderZombieVillager extends RenderBiped
{
    ...
    private static final ResourceLocation       customZombieVillager = new ResourceLocation(Reference.ModID + ":textures/entity/zombie_villager_test.png");
    ...
    {
        return ((EntityZombie)entity).isVillager() ? customZombieVillager : vanillaZombie;
    }
