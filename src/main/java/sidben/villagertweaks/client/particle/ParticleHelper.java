...
public class ParticleHelper
{
    ...
    public static EntityFX spawnParticle(EffectType effect, double xCoord, double yCoord, double zCoord)
    {
        if (mc != null && mc.getRenderViewEntity() != null && mc.effectRenderer != null) {
            ...
            final double var15 = mc.getRenderViewEntity().posX - xCoord;
            final double var17 = mc.getRenderViewEntity().posY - yCoord;
            final double var19 = mc.getRenderViewEntity().posZ - zCoord;
            final double var22 = 16.0D;
            ...
            final ParticlePotionEffect particle = new ParticlePotionEffect(effect, renderEngine, theWorld, xCoord, yCoord, zCoord);
