...
public class EntityEventHandler {
    ...
    public void onLivingDeath(LivingDeathEvent event) {
        ...
        // Debug
        /*
         * ModVillagerTweaks.logDebugInfo(
         * "==================================================================="
         * ); ModVillagerTweaks.logDebugInfo("onLivingDeath");
         * ModVillagerTweaks.logDebugInfo("	Side:       " +
         * FMLCommonHandler.instance().getEffectiveSide());
         * ModVillagerTweaks.logDebugInfo("    " + event.entity.toString());
         * ModVillagerTweaks.logDebugInfo("    " + event.source.damageType);
         * ModVillagerTweaks.logDebugInfo(
         * "==================================================================="
         * );
         */
    ...
    public void onLivingDrops(LivingDropsEvent event) {
        ...
        if (event.entity instanceof EntityZombie) {
            ...
            if (ConfigLoader.zombieVillagerDropEmerald) {
                ...
                // Only adult villager zombies will be affected, and only if
                // killed by players
                if (zombie.isChild() || !zombie.isVillager() || !event.recentlyHit)
                    return;
                ...
                for (int i = 0; i < event.drops.size(); i++) {
                    ...
                    if (droppedItem != null) {
                        if (droppedItem.itemID == Item.ingotIron.itemID) {
                            haveIngot = true;
                        }
                    }
                }
